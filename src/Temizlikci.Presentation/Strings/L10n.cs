...
public static class L10n
{
    ...
    public static string GrowthGrewBy(string size) => Format("growth.accessibility.grew", size);
    public static string GrowthShrankBy(string size) => Format("growth.accessibility.shrank", size);
    public static string GrowthAppearedHelp => Get("growth.appeared.help");
    public static string GrowthRemoved => Get("growth.removed");
    public static string GrowthEmptyTitle => Get("growth.empty.title");
    public static string GrowthEmptyMessage => Get("growth.empty.message");
    public static string GrowthNoChangesTitle => Get("growth.noChanges.title");
    public static string GrowthNoChangesMessage(string date) => Format("growth.noChanges.message", date);
    public static string GrowthHeader(string name, string date) => Format("growth.header", name, date);
    public static string GrowthGrewSection => Get("growth.section.grew");
    public static string GrowthShrankSection => Get("growth.section.shrank");
    public static string GrowthNet(string size) => Format("growth.net", size);
    public static string GrowthFromSavedScans(string date) => Format("growth.fromSavedScans", date);
    public static string GrowthShowInChart => Get("growth.showInChart");
    public static string GrowthPrevious(string size) => Format("growth.previous", size);
    public static string LargeFilesTitle(string name) => Format("largeFiles.title", name);
    public static string LargeFilesModified => Get("largeFiles.column.modified");
    public static string LargeFilesHint => Get("largeFiles.hint");
    public static string LargeFilesNoneTitle => Get("largeFiles.none.title");
    public static string LargeFilesNoneMessage => Get("largeFiles.none.message");
    public static string LargeFilesScanFirst => Get("largeFiles.empty.message");
    public static string ProjectsTitle => Get("projects.title");
    public static string ProjectsPeriodLabel => Get("projects.period.label");
    public static string ProjectsEmpty => Get("projects.empty");
    public static string ProjectsLastTouched(string date) => Format("projects.lastTouched", date);
    public static string ProjectsTotal(string size) => Format("projects.total", size);
    public static string ProjectsOnlyBuildOutput => Get("projects.onlyBuildOutput");
    public static string ProjectsLastWorkedOn => Get("projects.lastWorkedOn");
    public static string ProjectsBuildOutput => Get("projects.buildOutput");
    public static string ProjectsNoArtifacts => Get("projects.noArtifacts");
    public static string ProjectsUnknownActivity => Get("projects.unknownActivity");
    public static string GitTitle => Get("git.title");
    public static string GitReading => Get("git.reading");
    public static string GitUnreadable => Get("git.unreadable");
    public static string GitLocalWork => Get("git.localWork");
    public static string GitAllPushed => Get("git.allPushed");
    public static string GitLocalWorkBadge => Get("git.badge.localWork");
    public static string GitAllPushedBadge => Get("git.badge.allPushed");
    public static string GitBranch => Get("git.branch");
    public static string GitDetached => Get("git.detached");
    public static string GitNoRemote => Get("git.noRemote");
    public static string GitUnpushedCommits => Get("git.unpushedCommits");
    public static string GitBehind => Get("git.behind");
    public static string GitStaged => Get("git.staged");
    public static string GitUnstaged => Get("git.unstaged");
    public static string GitUntracked => Get("git.untracked");
